...
urlpatterns = [
    path("", views.home, name="home"),  # トップ（追加）
    ...
    path("sets/", views.set_list, name="set_list"),                 # 追加
    path("sets/<slug:slug>/", views.set_detail, name="set_detail"), # 追加
    path("sale/", views.sale_list, name="sale_list"),               # 追加
]
